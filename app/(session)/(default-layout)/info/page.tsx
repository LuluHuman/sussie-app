...
export default function Info() {
    return <div>
        <h1 className="text-4xl my-2">What is SUSSIE?</h1>
        <p>
        ...
        <h1 className="text-4xl my-2">How does it help with sustainability?</h1>
        <p>
        ...
        <h1 className="text-4xl my-2">How to use</h1>
        <p>
            Input an image as well as a question to the image SUSSIE will respond with ways to enourage sustainability.
        </p>

        <h1 className="text-4xl my-2">What makes it different from other products?</h1>
        <p>
        ...
        <p className="opacity-50 my-4">
            {"View the source code "}<a
                ...
                target="_blank"
                href="https://github.com/LuluHuman/sussie-app/tree/master/app">
                here (Github LuluHuman/sussie-app)
            </a>
        </p>
    </div>
}